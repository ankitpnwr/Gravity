...
var gravity = 1;
var friction = 0.7; // Event Listeners
...
var Ball = /*#__PURE__*/function () {
  ...
  _createClass(Ball, [{
    ...
    value: function update() {
      this.draw(); // Adding gravity and friction 
...
function init() {
  ...
  for (var i = 0; i < 400; i++) {
    ...
    var radius = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(10, 25);
    ...
    var color = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomColor"])(colors); // objects.push()
...
function animate() {
  ...
  c.clearRect(0, 0, canvas.width, canvas.height); // Draw and update every ball 
